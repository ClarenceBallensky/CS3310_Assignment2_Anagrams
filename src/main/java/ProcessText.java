 ...
 * Parses through words in a given input file to identify if any of the words are anagrams of each other
 */
...
public class ProcessText
{
    /**
     * Method: main
     * Purpose: parses through each word in the input file, groups all anagrams, saves to an output file
     */
    public static void main (String[] args) {
        ...
        try (Scanner sc = new Scanner(inputFile)) {
            while (sc.hasNextLine()) {
                ...
                String sortedKey = sortCharacters(word);
     ...
     * Purpose: sort the characters in a given string alphabetically and return the sorted string
